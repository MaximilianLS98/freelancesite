      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl m-auto">
          {services.map((service, index) => (
            <Link href={'/projects'} key={service.id}>
            <motion.div
              key={service.id}
              ...
              className="bg-white dark:bg-gray-700 rounded-lg shadow-custom shadow-black p-6 border-2 border-black flex flex-col h-full"
            >
